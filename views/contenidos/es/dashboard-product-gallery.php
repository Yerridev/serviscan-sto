                            ...
                            <?php if(is_file("./views/assets/product/gallery/".$campos_galeria['imagen_nombre'])){ ?>
                                <figure>
                                    <a data-fslightbox="gallery" href="<?php echo SERVERURL; ?>views/assets/product/gallery/<?php echo $campos_galeria['imagen_nombre']; ?>">
                                        <img class="img-fluid img-product-info" src="<?php echo SERVERURL; ?>views/assets/product/gallery/<?php echo $campos_galeria['imagen_nombre']; ?>" alt="<?php echo $campos['producto_nombre']; ?>">
                                    </a>
                                </figure>
                            <?php }else{ ?>
                                <figure>
                                    <img class="img-fluid img-product-info" src="<?php echo SERVERURL; ?>views/assets/product/gallery/default.jpg" alt="<?php echo $campos['producto_nombre']; ?>">
                                </figure>
                            <?php } ?>
                            <p class="text-center" style="margin-top: 40px;">
