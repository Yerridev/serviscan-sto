<div class="full-box bg-white">
    <div class="container container-web-page">
        ...
        <div class="container-fluid">
            <div class="row">
                <?php
                    include "./views/inc/".LANG."/btn_go_back.php";
                ...
                <div class="col-12 col-lg-5">
                    <figure class="full-box">
                        <?php if(is_file("./views/assets/product/cover/".$campos['producto_portada'])){ ?>
                            <img class="img-fluid" src="<?php echo SERVERURL."views/assets/product/cover/".$campos['producto_portada']; ?>" alt="<?php echo $campos['producto_nombre']; ?>">
                        <?php }else{ ?>
                            <img class="img-fluid" src="<?php echo SERVERURL; ?>views/assets/product/cover/default.jpg" alt="<?php echo $campos['producto_nombre']; ?>">
                        <?php } ?>
                    </figure>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="galery-details full-box">
                        ...
                        <figure class="full-box">
                            <?php if(is_file("./views/assets/product/gallery/".$campos_galeria['imagen_nombre'])){ ?>
                            <a data-fslightbox="gallery" href="<?php echo SERVERURL; ?>views/assets/product/gallery/<?php echo $campos_galeria['imagen_nombre']; ?>">
                                <img class="img-fluid" src="<?php echo SERVERURL; ?>views/assets/product/gallery/<?php echo $campos_galeria['imagen_nombre']; ?>" alt="<?php echo $campos['producto_nombre']; ?>">
                            </a>
                            <?php }else{ ?>
                            <a data-fslightbox="gallery" href="<?php echo SERVERURL; ?>views/assets/product/gallery/default.jpg">
                                <img class="img-fluid" src="<?php echo SERVERURL; ?>views/assets/product/gallery/default.jpg" alt="<?php echo $campos['producto_nombre']; ?>">
                            </a>
                            <?php } ?>
                        </figure>
                        <?php } ?>
                ...
                <script src="<?php echo SERVERURL; ?>views/js/fslightbox.js"></script>
                <?php 
                        }
                    }else{ include "./views/inc/".LANG."/error_alert.php";}
                ?>
            </div>
        </div>
    </div>
