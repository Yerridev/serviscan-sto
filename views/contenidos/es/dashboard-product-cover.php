                ...
                <div class="col-12 col-md-6">
                    <?php if(is_file("./views/assets/product/cover/".$campos['producto_portada'])){ ?>
                        <form class="FormularioAjax" data-lang="<?php echo LANG; ?>" action="<?php echo SERVERURL; ?>ajax/productoAjax.php" method="POST" data-form="delete" autocomplete="off" >
                            ...
                            <figure>
                                <img class="img-fluid img-product-info" src="<?php echo SERVERURL; ?>views/assets/product/cover/<?php echo $campos['producto_portada']; ?>" alt="<?php echo $campos['producto_nombre']; ?>">
                            </figure>
                    ...
                    <?php }else{ ?>
                        <figure>
                            <img class="img-fluid img-product-info" src="<?php echo SERVERURL; ?>views/assets/product/cover/default.jpg" alt="<?php echo $campos['producto_nombre']; ?>">
                        </figure>
                    <?php } ?>
                </div>
                <div class="col-12 col-md-6">
