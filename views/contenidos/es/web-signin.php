<!-- <section class="container-cart container-signin">
    <div class="login-content mb-4">
        <figure class="full-box mb-4">
            <img src="<?php echo SERVERURL; ?>views/assets/avatar/Avatar_default_male.png" alt="" class="img-fluid login-icon">
        </figure>
...
<?php
    if(isset($_POST['login_email']) && isset($_POST['login_clave'])){
        ...
        $ins_cliente = new userControlador();
        $ins_cliente->iniciar_sesion_cliente_controlador();
    }
?>
