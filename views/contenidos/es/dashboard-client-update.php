    ...
    <form class="dashboard-container FormularioAjax" method="POST" data-form="update" data-lang="<?php echo LANG; ?>" autocomplete="off" action="<?php echo SERVERURL;?>ajax/clienteAjax.php" >
        ...
        <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <?php 
                        $directorio_avatar=opendir("./views/assets/avatar/");
                        $check="";
                        $c=1;
                        while($avatar=readdir($directorio_avatar)){
                            if(is_file("./views/assets/avatar/".$avatar)){
                                ...
                                echo '
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <div class="form-check radio-avatar-form">
                                            ...
                                            <label class="form-check-label" for="radio_avatar_'.$c.'" ><img src="'.SERVERURL.'views/assets/avatar/'.$avatar.'" alt="'.$avatar.'" class="img-fluid radio-avatar-img"></label>
                                        </div>
                                    </div>
                                ';
                                $check="";
